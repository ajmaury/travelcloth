...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'customer.mobile_check'=> \App\Http\Middleware\CustomerRedirectMobileCheck::class,
        ...
        'partneragent.mobile_check'=> \App\Http\Middleware\PartnerAgentRedirectMobileCheck::class,
        'partneragent.guest'    => \App\Http\Middleware\PartnerAgentRedirectIfAuthenticated::class,
        //Hotel Partner
        'hotelpartner.mobile_check'=> \App\Http\Middleware\HotelPartnerRedirectMobileCheck::class,
        ...
        //Associate
        'associate.mobile_check'=> \App\Http\Middleware\AssociateRedirectMobileCheck::class,

...
@section('content')
    <form action="{{ route('hotelpartner.register') }}" method="POST">
        @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ route('hotelpartner.index') }}">@yield('page_title')</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="hotelName" id="hotelName" class="form-control @error('hotelName') form-control-error @enderror" required="required" value="{{ old('hotelName') }}">
                                    @error('hotelName')

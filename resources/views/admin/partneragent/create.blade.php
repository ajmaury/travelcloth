...
@section('content')
    <form action="{{ route('partneragent.register') }}" method="POST">
        @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ route('partneragent.index') }}">@yield('page_title')</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="companyName" id="companyName" class="form-control @error('companyName') form-control-error @enderror" required="required" value="{{ old('companyName') }}">
                                    @error('companyName')

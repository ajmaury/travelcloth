    ...
    <div class="row justify-center">
      <div class="col-xl-6 col-lg-7 col-md-9">
        <div class="px-50 py-50 sm:px-20 sm:py-20 bg-white shadow-4 rounded-4">
          <form action="{{ route('hotelpartner.login_go') }}" method="POST">
            @csrf()
            <div class="row y-gap-20">
              ...
              <div class="col-12">
                <a href="{{ route('hotelpartner.forget.password.get') }}" class="text-14 fw-500 text-blue-1 underline">Forgot your password?</a>
              </div>
              <div class="col-12">
